...
?>
    ...
    <body>
        ...
        <table class="table table-striped" id="alimentTable">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="table-primary">Glucides (g/100g)</th>
                    <th scope="col" class="table-primary">Protéines (g/100g)</th>
        ...
        <form id="alimentForm">
            ...
            <div class="mb-3 ms-1 row">
                <label for="glucides" class="col-sm-2 col-form-label">Glucides (g/100g)</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="glucides" id="inputGlucides">
                </div>
            </div>
            <div class="mb-3 ms-1 row">
                <label for="proteines" class="col-sm-2 col-form-label">Protéines (g/100g)</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="proteines" id="inputProteines">
                </div>
            </div>
